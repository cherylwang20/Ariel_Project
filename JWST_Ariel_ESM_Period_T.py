...
# cmap='viridis_r'
cmap = 'cool'
JWST_plot = ax.scatter(pc_telescope.query("JWST == 'Yes'")["pl_eqt"], pc_telescope.query("JWST == 'Yes'")["pl_orbper"],
...
for x, y, name in zip(pc_telescope.query("JWST == 'Yes'")["pl_eqt"], pc_telescope.query("JWST == 'Yes'")["pl_orbper"],
...
ax.scatter(SS_eqt, SS_orb)

for x0, y0, path, z in zip(SS_eqt, SS_orb, paths, zooms):
