...
Ariel_transit_1= ax.plot(tier_1_index,tier_1_list,
                          alpha = 1, linewidth= 3, label = 'Tier 1')
...
Ariel_transit_2 = ax.plot(tier_2_index, tier_2_list,
                          alpha = 1, linewidth= 3, label = 'Tier 2')
...
plt.xticks(fontsize=17)
plt.yticks(fontsize=17)
plt.legend(title = 'Transmission',loc = "lower right", fontsize = 15, title_fontsize= 15)
#plt.yscale('log')
#plt.xscale('log')
#plt.ylim([0,1095])
...
ax1.hist([transit_1, transit_2, transit_3], bins= bin_num, rwidth= 0.85,
...
plt.xticks(fontsize=17)
plt.yticks(fontsize=17)
ax2.hist([ATSM_1,ATSM_2,ATSM_3], bins = bin_num, rwidth= 0.85,
