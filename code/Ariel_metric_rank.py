...
Ariel_plot = ax.scatter(ariel_sort_eclipse_num.index.tolist(), ariel_sort_eclipse_num['ASM'],
...
plt.xlabel("Planet Rank", fontsize=18)
plt.ylabel("Ariel SNR Metric", fontsize=18)
plt.title("Ariel Phase Curve Targets - Tier 3 Eclipse Ranked", fontsize=24)
plt.yscale('log')
# plt.ylim([0,105])
plt.savefig(save_dir + 'Ariel-PhaseCurve-Eclipse-ASM-Rank.jpg')
