...
plt.legend(title = "Phase Curve", loc = "lower right", fontsize = 15, title_fontsize= 15)
#plt.yscale('log')
#plt.xscale('log')
plt.ylim([0,2000])
...
plt.xticks(fontsize=17)
plt.yticks(fontsize=17)
plt.legend(title = "Emission Target", loc = "upper left", fontsize = 15, title_fontsize= 15)
#plt.yscale('log')
#plt.xscale('log')
#plt.ylim([0,2000])
